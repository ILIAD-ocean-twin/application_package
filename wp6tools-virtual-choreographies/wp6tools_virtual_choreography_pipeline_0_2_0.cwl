...
#       File
  ...
  s:codeRepository: https://pipe-drive.inesctec.pt/application-packages/workflows/wp6tools/wp6tools-contours.cwl
...
- class: CommandLineTool
  ...
  outputs:
    output_files:
      type: File[]
      outputBinding:
        glob: $(runtime.outdir)/$(inputs.input_dir.basename)/*.*
  ...
  s:dateCreated: "2024-11-19T14:43:47Z"
...
- class: CommandLineTool
  ...
  requirements:
    ...
    InlineJavascriptRequirement: {}
    DockerRequirement:
      dockerPull: iliad-repository.inesctec.pt/2stac2:2.0.0
  ...
  s:author:
    - class: s:Person
      s:name: Miguel Correia
      s:email: miguel.r.correia@inesctec.pt
  s:codeRepository: https://pipe-drive.inesctec.pt/application-packages/tools/2stac2/2stac2_2_0_0.cwl
  s:dateCreated: "2024-11-14T17:53:27Z"
