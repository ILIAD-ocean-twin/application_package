...
- class: Workflow
  ...
  steps:
    ...
    step_simulate_metadata:
      ...
      - metadata
    step_2stac2:
      run: 'https://pipe-drive.inesctec.pt/application-packages/tools/2stac2/2stac2_sleeper_pipeline_0_2_0.cwl#2stac2_sleeper_pipeline'
      in:
  ...
  s:codeRepository: https://pipe-drive.inesctec.pt/application-packages/workflows/sleeper/sleeper_REF_0_1_1.cwl
