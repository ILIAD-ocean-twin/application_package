...
- class: Workflow
  ...
  steps:
    ...
    step_animation:
      ...
      - animation
    step_2stac2:
      run: 'https://pipe-drive.inesctec.pt/application-packages/tools/2stac2/2stac2_openoil_pipeline_0_1_0.cwl#2stac2_openoil_pipeline'
      in:
  ...
  s:codeRepository: https://pipe-drive.inesctec.pt/application-packages/workflows/openoil-duth/openoil_duth_REF_0_1_0.cwl
