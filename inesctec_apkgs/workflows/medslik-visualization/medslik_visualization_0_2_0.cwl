...
$graph:
  - class: Workflow
    ...
    steps:
      step_medslik:
        run: '#oilspill_pipeline_medslik_158'
        in:
    ...
    s:codeRepository: >-
      https://pipe-drive.inesctec.pt/application-packages/workflows/medslik-visualization/medslik_visualization_0_2_0.cwl
    s:dateCreated: '2025-06-10T02:03:20Z'
  ...
  - class: Workflow
    id: oilspill_pipeline_medslik_158
    ...
    steps:
      ...
      step_netcdf_metadata:
        in:
          medslik_result: step_medslik/results
        run: '#netcdf_metadata_medslik'
        out:
          - metadata
      step_2stac:
        in:
        ...
        run: '#2stac2_medslik_pipeline'
        out:
          - stac_result
    outputs:
      pipeline_output:
        type: Directory
        outputSource: step_2stac/stac_result
  ...
  - class: CommandLineTool
    ...
    requirements:
      - class: DockerRequirement
        dockerPull: iliad-repository.inesctec.pt/meeo-oilspill001:1.0.0
      - class: NetworkAccess
        networkAccess: true
      ...
      - class: InitialWorkDirRequirement
        listing:
          - entryname: $(inputs.use_case_directory.basename)
            ...
            writable: true
      - class: DockerRequirement
        dockerPull: iliad-repository.inesctec.pt/meeo-oilspill002:1.0.0
      - class: NetworkAccess
        networkAccess: true
      - class: InlineJavascriptRequirement
      ...
      - class: InitialWorkDirRequirement
        listing:
          - entryname: $(inputs.use_case_directory.basename)
            ...
            writable: true
      - class: DockerRequirement
        dockerPull: iliad-repository.inesctec.pt/meeo-oilspill003:2.0.0
      - class: NetworkAccess
        networkAccess: true
      - class: InlineJavascriptRequirement
      ...
      - class: InitialWorkDirRequirement
        listing:
          - entryname: $(inputs.use_case_directory.basename)
            ...
            writable: true
      - class: DockerRequirement
        dockerPull: iliad-repository.inesctec.pt/meeo-oilspill005:2.0.0
      - class: NetworkAccess
        networkAccess: true
      - class: InlineJavascriptRequirement
  ...
  - class: CommandLineTool
    ...
    outputs:
      results:
        ...
        type: Directory
        doc: NetCDF output file with the Medslik simulation results
    requirements:
      - class: InlineJavascriptRequirement
      - class: DockerRequirement
  ...
  - class: CommandLineTool
    ...
    s:author:
      - class: s:Person
        ...
        s:email: miguel.r.correia@inesctec.pt
    s:codeRepository: >-
      https://pipe-drive.inesctec.pt/application-packages/tools/netcdf-metadata/netcdf_metadata_medslik_pipeline_0_1_0.cwl
    s:dateCreated: '2025-06-08T22:08:27Z'
  - class: CommandLineTool
    ...
    s:author:
      ...
      s:email: miguel.r.correia@inesctec.pt
    s:codeRepository: >-
      https://pipe-drive.inesctec.pt/application-packages/tools/2stac2/2stac2_medslik_pipeline_0_2_0.cwl
