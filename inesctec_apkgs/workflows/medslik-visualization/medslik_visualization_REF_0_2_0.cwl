...
- class: Workflow
  ...
  steps:
    step_medslik:
      run: 'https://pipe-drive.inesctec.pt/cwl/medslik_158.cwl#oilspill_pipeline_medslik_158'
      in:
    ...
    step_metadata_2stact2:
      run: 'https://pipe-drive.inesctec.pt/application-packages/tools/wp6tools-metadata-2stac2/wp6tools_metadata_2stac2_0_2_0.cwl#metadata_2stact2'
      in:
        latitude: lat_point
        longitude: lon_point
        radius:
  ...
  s:codeRepository: https://pipe-drive.inesctec.pt/application-packages/workflows/medslik-visualization/medslik_visualization_REF_0_2_0.cwl
