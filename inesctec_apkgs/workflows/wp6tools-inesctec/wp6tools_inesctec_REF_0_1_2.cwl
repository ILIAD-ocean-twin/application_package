...
- class: Workflow
  ...
  steps:
    ...
    step_bathymetry:
      ...
      - metadata
    step_generate_model:
      run: 'https://pipe-drive.inesctec.pt/application-packages/tools/wp6tools-generate-model/wp6tools_generate_model_0_1_3.cwl#generate-model'
      in:
        type: type
        url: url
        latitude: latitude
  ...
  s:codeRepository: https://pipe-drive.inesctec.pt/application-packages/workflows/wp6tools-inesctec/wp6tools_inesctec_REF_0_1_2.cwl
  s:dateCreated: "2025-05-30T13:34:36Z"
