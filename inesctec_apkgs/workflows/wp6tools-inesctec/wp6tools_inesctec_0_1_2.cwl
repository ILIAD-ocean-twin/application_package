...
$graph:
  - class: Workflow
    ...
    s:codeRepository: >-
      https://pipe-drive.inesctec.pt/application-packages/workflows/wp6tools-inesctec/wp6tools_inesctec_0_1_2.cwl
  ...
  - class: CommandLineTool
    ...
    s:contributor:
      - class: s:Person
        ...
        s:email: miguel.r.correia@inesctec.pt
    s:codeRepository: >-
      https://pipe-drive.inesctec.pt/application-packages/tools/wp6tools-generate-model/wp6tools_generate_model_0_1_3.cwl
