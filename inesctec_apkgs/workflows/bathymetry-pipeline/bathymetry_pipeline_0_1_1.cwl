...
$graph:
  - class: Workflow
    ...
    s:codeRepository: >-
      https://pipe-drive.inesctec.pt/application-packages/workflows/bathymetry-pipeline/bathymetry_pipeline_0_1_1.cwl
  ...
  - class: CommandLineTool
    ...
    s:author:
      - class: s:Person
        ...
        s:email: miguel.r.correia@inesctec.pt
    s:codeRepository: >-
      https://pipe-drive.inesctec.pt/application-packages/tools/2stac/2stac_0_1_0.cwl
