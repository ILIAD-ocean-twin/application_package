...
- class: CommandLineTool
  ...
  requirements:
    ...
    DockerRequirement:
      dockerPull: iliad-repository.inesctec.pt/virtual-choreographies-transformer-plugin:0.3.0
  ...
  s:codeRepository: https://pipe-drive.inesctec.pt/application-packages/tools/virtual-choreographies-transformer-plugin-cesium/virtual_choreographies_transformer_plugin_cesium_0_3_0.cwl
